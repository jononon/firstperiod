  ...
  function calculateRoute() {
    directionsService.route({
      ...
      if(status=='OK'){
        ...
        message += "<p>It's currently "+((now.getHours()%12)==0?12:(now.getHours()%12))+":"+(now.getMinutes()<10?"0":"")+now.getMinutes()+" and it will take you <b>"+parseInt(travelMins)+" mins</b> to get to school. That means that you'll arrive at <b>"+arrivalHours+":"+(arrivalMins<10?"0":"")+arrivalMins+"</b></p>"
        $('#result').html(message);
      }
    });
  }
